            ...
            <div className="absolute top-0 flex h-full w-full items-center justify-content text-center">
                <div className="mx-auto flex flex-col items-center">
                    ...
                    <div className="flex items-center">
                        ...
                        <a href="#kontakt">
                            <button className="rounded-full bg-green-500 w-16 h-16 p-1 transition ease-in-out delay-150 hover:-translate-1 hover:scale-110">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-white items-center" viewBox="0 0 20 20" fill="currentColor">
