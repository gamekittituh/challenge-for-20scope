export const Partner = () => {
    return(
        <div className="bg-gradient-to-t to-white px-4 pt-14 pb-[67px] text-center md:pb-[114px] md:pt-[104px] lg:pb-[121px] font-semibold">
            <p className="mb:mb-8 md:leadig-6 mx-auto mb-[42px] max-w-[288px] leading-[19px] md:max-w-[683px] md:text-lg lg:mb-16 lg:max-w-[750px] lg:text-2xl lg:leading-[29px]">
                ...
                <span className="ml-2 text-lime-500">Qualität und hohen Leistungsstandards.</span>
            </p>
